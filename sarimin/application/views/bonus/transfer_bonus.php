...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        grid.jqGrid({
            url: '<?php echo site_url('bonus/gridTransferBonus');?>',
            datatype: "json",
            mtype: "POST",
            caption: "List Menu",
            colModel: [
                ...
                },
                {
                    ...
                    /*formatter : function (cellvalue, options, rowObject){
                        return cellvalue + " (" + rowObject.AccountID + ")";
                    }*/
                },
                {
                    label: 'Destination',
                    ...
                    editable: false
                    /*formatter : function (cellvalue, options, rowObject){
                        return cellvalue + " (" + rowObject.DestinationAccount + ")";
                    }*/
                },
                {
                    label: 'Amount Transfer (USD)',
                    name: 'Transfer',
                    width: 140,
                    align: "right",
                    editable: true,
