...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        grid.jqGrid({
            url: '<?php echo site_url('parameter/gridAccountType');?>',
            datatype: "json",
            mtype: "POST",
            caption: "List Menu",
            colModel: [
                ...
                },
                {
                    ...
                    align: "left",
                    editable: true,
                    editrules: {number: true,required: true, maxValue:12 ,size: 10}
                ...
                {
                    label: 'WD Deposite Fee',
                    name: 'WDDepositFeeRate',
                    width: 140,
                    align: "right",
                    editable: true,
                    formatter: 'number',
