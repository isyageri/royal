...
<script type="text/javascript">
    $(document).ready(function () {
         ...
         jQuery("#grid-table").jqGrid({
                 ...
                 colModel: [
                     ...
                     { label: 'Nama Menu', name: 'MENU_NAME', width:140, align:"left", editable:true,editrules : { required: true}},
                     { label: 'Menu Parent', name: 'MENU_PARENT', width:140, align:"left", editable:true,hidden:true,editrules : { required: true,edithidden:true},editoptions: {defaultValue:'0',readonly: 'readonly'}},
                 ...
                 onSelectRow: function(rowid) {
                    ...
                    if(rowid != null) {
                        grid_id.jqGrid('setGridParam',{url:"<?php echo site_url('admin/menuchild');?>/"+rowid,datatype: 'json',postData:{parent_id:rowid}, userData:{tes:rowid}}); // the last setting is for demo only
    ...
    $("#jqGridDetails").jqGrid({
        ...
        page: 1,
        colModel: [
            { label: 'Menu ID', name: 'MENU_ID', key: true, width: 35, editable: true,hidden:true },
           // { label: 'Parent', name: 'MENU_PARENT', width: 65, editable: true, hidden:false,editoptions: {size:30, maxlength: 15} },
            { label: 'Nama Menu', name: 'MENU_NAME', width: 140, editable: true },
            { label: 'Controller', name: 'MENU_LINK', width: 145, editable: true },
            { label: 'View', name: 'FILE_NAME', width: 165, editable: true }
        ],
        width: 1120,
        height: '100%',
        rowNum: 5,
...
//    jQuery('#jqGridDetails').jqGrid('navButtonAdd','#jqGridDetailsPager',{
//        caption: "Click me!",
//        onClickButton: function () {
