...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        grid.jqGrid({
            url: '<?php echo site_url('client/gridClient');?>',
            datatype: "json",
            mtype: "POST",
            caption: "List Menu",
            colModel: [
                ...
                },
                {
                    ...
                    formatter: function (cellvalue) {
                        if (cellvalue == 1) {
                            return '<button class="btn btn-round btn-mini btn-success" data-toggle="dropdown" aria-expanded="false"> Active </button> ';
                        } else {
                            return '<button class="btn btn-round btn-mini btn-grey" data-toggle="dropdown" aria-expanded="false"> Inactive </button> ';
                        }
