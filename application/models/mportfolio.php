...
class mPortfolio extends CI_Model {
	...
	public function GetPortfolio() {
		$sql = "SELECT * FROM portfolio ORDER BY PortfolioID";
		$dat = rst2Array($sql);
		return $dat;
	}
	
	public function SectorAllocation() {
		$sql = "SELECT IndustryName AS label, MoneyAllocation AS value FROM industrysector";
