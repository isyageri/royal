...
function __construct() {
		...
		$this->smarty->assign('content_title', "What We Do");
	...
	{	
		...
		$this->smarty->assign('whatwedo', $this->mWhatwedo->GetWhatwedo());
		$this->smarty->display("whatwedo.tpl");
	}
