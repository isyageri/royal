...
{if $access.p_retrieve==1}
	{if $datx.dat}
		...
		<tr class="{cycle values='even,odds'} hover">
			...
			<td class="icons center">
				{if $access.p_update==1}<a class="easyui-linkbutton" plain="true" icon="icon-edit_doc" rel="#f{$menu}" href="#f{$menu}" onclick="additional_data(this,'#6341/additional_data')" title="Edit Detail Penjualan"></a>{/if}
			</td>
		</tr>
		{/foreach}
	...
	{/if}
{/if}
{include file="home/page_tfoot_no_add.tpl" col=9}