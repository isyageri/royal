...
<head>
    ...
    <link rel="stylesheet" href="{$host}__assets/css/ui/tablecomp.css" type="text/css" />
    ...
    <link rel="stylesheet" href="{$host}__assets/css/ui/services.css" type="text/css" />
    ...
    <link rel="stylesheet" href="{$host}__assets/css/ui/jquery-ui.css">
                    ...
                    <li>
                        ...
                        <ul class="menu-2deep">
                            <li>
                                ...
                                <ul class="menu-3deep">
                                    {foreach name=data from=$whatweoffermenu item=wwo}
                                        <li>
    ...
    $(document).ready(function(){
       var csrf_hash = '{$csrf_hash}';
        $("#comparison").click(function(){
            $.ajax({
                type: 'POST',
                url: '{$host}index.php/whatweoffer/comparison',
