<h3 class="lighter block green">Security and Agreements</h3>
...
You represent and warrant that you are a Professional Investor as defined above and accessing this website from within a jurisdiction in which the use of this website by investment professionals is not under local laws and regulations. 
	...
	<form class="form-horizontal" id="validation-form5" method="get" >
		...
		<div class="control-group">
						...
						<img id="siimage" style="border: 1px solid #000; margin-right: 15px" src="{$host}__assets/lib/securimage/securimage_show.php?sid=<?php echo md5(uniqid()) ?>" alt="CAPTCHA Image" align="left" />
						<object class="fl" type="application/x-shockwave-flash" data="{$host}__assets/lib/securimage/securimage_play.swf?bgcol=#ffffff&amp;icon_file={$host}__assets/lib/securimage/images/audio_icon.ico&amp;audio_file={$host}__assets/lib/securimage/securimage_play.php" height="32" width="32">
						<param name="movie" value="{$host}__assets/lib/securimage/securimage_play.swf?bgcol=#ffffff&amp;icon_file={$host}__assets/lib/securimage/images/audio_icon.ico&amp;audio_file={$host}__assets/lib/securimage/securimage_play.php" />
						</object>
						&nbsp;
						<a class="fl" tabindex="-1" style="border-style: none;margin-left:5px;" href="#" title="Refresh Image" onclick="document.getElementById('siimage').src = '{$host}__assets/lib/securimage/securimage_show.php?sid=' + Math.random(); this.blur(); return false"><img src="{$host}__assets/lib/securimage/images/refresh.png" alt="Reload Image" height="32" width="32" onclick="this.blur()" align="bottom" border="0" /></a><br />
						<br/>
