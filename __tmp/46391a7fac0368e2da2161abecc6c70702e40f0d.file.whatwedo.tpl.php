<?php /* Smarty version Smarty-3.1.7, created on 2016-04-25 10:07:29
         compiled from "__views/whatwedo.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1235259083571dde51d7e738-22177317%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '46391a7fac0368e2da2161abecc6c70702e40f0d' => 
    array (
      0 => '__views/whatwedo.tpl',
      1 => 1431486146,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1235259083571dde51d7e738-22177317',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_571dde52036c1',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_571dde52036c1')) {function content_571dde52036c1($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en-GB">
<head>
    <meta charset="UTF-8" />
...
'>
                <img class="brand-logo" height='46' width='269' alt='Barclays Personal Banking' src='<?php echo $_smarty_tpl->tpl_vars['host']->value;?>
...
<div class="page">
	...
	<div class="content" style="width:940px;">
		<div class="content-list-desc" >  
				<?php  $_smarty_tpl->tpl_vars['wwd'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['wwd']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['whatwedo']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['wwd']->key => $_smarty_tpl->tpl_vars['wwd']->value){
$_smarty_tpl->tpl_vars['wwd']->_loop = true;
?>
				<?php echo $_smarty_tpl->tpl_vars['wwd']->value['Description'];?>
