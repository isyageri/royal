<?php /* Smarty version Smarty-3.1.7, created on 2016-04-25 10:07:34
         compiled from "__views/whoweare.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1374212317571dde56ee4c01-63154384%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9695a1ba5a17848051be0ca9dff49e7d4c4bd6ac' => 
    array (
      0 => '__views/whoweare.tpl',
      1 => 1431486146,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1374212317571dde56ee4c01-63154384',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_571dde570d73a',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_571dde570d73a')) {function content_571dde570d73a($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en-GB">
<head>
    <meta charset="UTF-8" />
...
<div class="content" style="width:940px;">
    <div class="content-list-desc">
        <div class="container"> 
            <div class="columns">
			<?php  $_smarty_tpl->tpl_vars['wwa'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['wwa']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['whoweare']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['wwa']->key => $_smarty_tpl->tpl_vars['wwa']->value){
$_smarty_tpl->tpl_vars['wwa']->_loop = true;
?>
			<?php echo $_smarty_tpl->tpl_vars['wwa']->value['Description'];?>
